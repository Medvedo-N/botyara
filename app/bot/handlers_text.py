...
from app.bot.fsm.scenarios import parse_inventory_input, start_state_for_action
...
async def text_router_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if action is not None:
        ...
        prompts = {
            ...
            'STOCK': 'Введите товар для остатков: <товар>,1',
        }
    ...
    try:
        ...
        elif state == DialogState.WAITING_STOCK:
